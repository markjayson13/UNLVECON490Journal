...
Issue (semester/year): __________________________________
Paper ID (if known): ____________________________________

Authors (print names):
1) ____________________________   Signature: ____________   Date: ____________
2) ____________________________   Signature: ____________   Date: ____________
3) ____________________________   Signature: ____________   Date: ____________

Advisor approval (if required):
Name: __________________________  Signature: _____________  Date: ____________
...
Contact email for notifications: _____________________________________________
```
